...
namespace OoLunar.Tomoe.Interactivity
{
    public static class ExtensionMethods
    {
        ...
        public static async ValueTask<string?> PickAsync(this CommandContext context, string question, IReadOnlyList<string> options, IComponentCreator? componentCreator = null, CancellationToken cancellationToken = default) => await context.ServiceProvider.GetRequiredService<Procrastinator>().PickAsync(context, question, options, componentCreator, cancellationToken);

        public static async ValueTask<IReadOnlyList<string>> ChooseAsync(this CommandContext context, string question, IReadOnlyList<string> options, IComponentCreator? componentCreator = null, CancellationToken cancellationToken = default) => await context.ServiceProvider.GetRequiredService<Procrastinator>().ChooseAsync(context, question, options, componentCreator, cancellationToken);
