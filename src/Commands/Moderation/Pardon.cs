...
namespace Tomoe.Commands.Moderation {
    public class Pardon : InteractiveBase {

        [Command("pardon", RunMode = RunMode.Async)]
        [Summary("Pardons a member.")]
        [Remarks("Moderation")]
        ...
        public async Task ByID(ulong victimId, [Remainder] string reason = null) {
            ...
            dialogContext.UserAction = Tomoe.Utils.Dialog.Context.Action.Pardon;
            ...
            try {
                Utils.Cache.Strikes.Remove(Context.Guild.Id, dialogContext.Victim.Id);
