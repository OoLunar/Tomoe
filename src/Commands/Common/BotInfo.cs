...
namespace Tomoe.Commands.Common
{
	public class BotInfo : BaseCommandModule
	{
		...
		public Task BotInfoAsync(CommandContext context)
		{
			...
			embedBuilder.AddField("Guild Count", Program.MemberCounts.Count.ToMetric(), true);
			embedBuilder.AddField("Member Count", Program.MemberCounts.Values.Sum().ToMetric(), true);
