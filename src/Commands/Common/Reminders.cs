...
namespace Tomoe.Commands.Common
{
	...
	public class Reminders : BaseCommandModule
	{
		...
		//public Task SetAsync(CommandContext context, TimeSpan expiresIn, [RemainingText] string? content = null) => SetAsync(context, DateTime.UtcNow.Add(expiresIn), content);

		[GroupCommand, Aliases("set", "me", "add"), Description("Sets a reminder using dates.")]
		public Task SetAsync(CommandContext context, DateTime expiresAt, [RemainingText] string? content = null)
		{
