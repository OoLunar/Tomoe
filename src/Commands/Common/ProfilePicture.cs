...
namespace Tomoe.Commands.Common
{
    ...
    {
        [Command("profile_picture"), Description("Gets the profile picture of the requested user. Defaults to the requester when no user is specified."), Aliases("pfp", "avatar")]
