...
namespace Tomoe.Utils.Cache {
    public class Tasks {
        public List<Tomoe.Commands.Reminder.Action> TaskType = new List<Commands.Reminder.Action>();
        ...
        public static Tasks? GetTasks(Tomoe.Commands.Reminder.Action taskType, ulong userID) {
            ...
            while (dataReader.Read()) {
                task.TaskType.Add((Tomoe.Commands.Reminder.Action) int.Parse(dataReader[0].ToString()));
        ...
        public static Tasks? GetTasks() {
            ...
            while (dataReader.Read()) {
                allTasks.TaskType.Add((Tomoe.Commands.Reminder.Action) int.Parse(dataReader[0].ToString()));
                ...
                allTasks.SetOff.Add(DateTime.Parse(dataReader[4].ToString()));
                allTasks.SetAt.Add(DateTime.Parse(dataReader[5].ToString()));
                allTasks.Content.Add((string) dataReader[6]);
            }
            dataReader.Close();
            return allTasks;
        }

        public static void AddTask(Tomoe.Commands.Reminder.Action taskType, ulong guildID, ulong channelID, ulong userID, DateTime setOff, DateTime setAt, string content) {
        ...
        public static void RemoveTask(Tomoe.Commands.Reminder.Action taskType, ulong userID, DateTime setAt, DateTime setOff) {
