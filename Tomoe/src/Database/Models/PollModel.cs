...
namespace OoLunar.Tomoe.Database.Models
{
    ...
    public sealed class PollModel : IExpirable<PollModel>
    {
        ...
        /// <summary>
        /// The channel id that the poll was created in.
        /// </summary>
        public ulong ChannelId { get; init; }

        /// <summary>
        /// The message id that the poll is attached to.
        /// </summary>
        public ulong MessageId { get; init; }

        /// <summary>
        /// A lazily evaluated dictionary of the winners of the poll.
        /// </summary>
        [NotMapped]
        private readonly Lazy<Dictionary<string, int>> _winners;

        /// <summary>
        /// A dictionary of the winners of the poll.
        /// </summary>
        [NotMapped]
        private Dictionary<string, int> Winners => _winners.Value;

        /// <summary>
        /// Creates an empty poll, usually called by EF Core. The _winners lazy is initialized here since the Options property is not set until after the constructor is called.
        /// </summary>
        ...
        /// <summary>
        /// Expires the poll, sending the results to the channel with an attached image. The poll is only deleted when it has been successfully sent to Discord or when we've encountered expected errors.
        /// </summary>
        ...
        /// <summary>
        /// Generates a bar graph of the poll results, returning the image as a <see cref="Stream"/>.
        /// </summary>
        /// <returns>A bar graph of the poll results, in image form.</returns>
