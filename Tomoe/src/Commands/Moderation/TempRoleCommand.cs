...
namespace Tomoe.Commands.Moderation
{
    public sealed class TempRoleCommand : ApplicationCommandModule
    {
        ...
        public async Task TempRoleAsync(InteractionContext context, TimeSpan timeSpan, DiscordRole discordRole, DiscordMember discordMember)
        {
            ...
            TempRoleModel tempRole = new(context.Guild.Id, discordRole.Id, discordMember.Id, context.User.Id, DateTime.UtcNow + timeSpan);
        ...
        public async Task TempRoleAsync(InteractionContext context, DateTime dateTime, DiscordRole discordRole, DiscordMember discordMember)
        {
            ...
            TempRoleModel tempRole = new(context.Guild.Id, discordRole.Id, discordMember.Id, context.Member.Id, dateTime.ToUniversalTime());
            Database.TemporaryRoles.Add(tempRole);
            await Database.SaveChangesAsync();
